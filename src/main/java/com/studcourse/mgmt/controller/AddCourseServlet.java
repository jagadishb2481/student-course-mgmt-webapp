...
public class AddCourseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       // addCourse.setId(Long.parseLong(id));
        ...
        HttpEntity<Course> entity = new HttpEntity<>(addCourse, headers);

        // Make the PUT request to update the course 
       // String updateUrl = COURSE_API_URL + "/" + id; 
        ResponseEntity<Course> responseEntity = restTemplate.exchange(COURSE_API_URL, HttpMethod.POST, entity, Course.class);
